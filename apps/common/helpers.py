...
def get_distance_helper(unit):
    return Haversine(unit)
...
class Haversine:
    ...
    def __init__(self, unit):
        self._unit = unit
        self._average_earth_radius = self._get_avg_earth_radius()

    def _get_avg_earth_radius(self):
    ...
    def __call__(self, point1, point2):
        ...
        return 2 * self._average_earth_radius * asin(sqrt(d))
